...
public class OptionTests
{
    ...
    public IEnumerable<CardType> ShouldIdentify(string cardNumber, bool ignoreNoise) => Cardidy.Identify(cardNumber, useAlgorithm: false, ignoreNoise: ignoreNoise);
    ...
    public IEnumerable<CardType> ShouldIdentifyAnonymizedCard(string cardNumber, bool handleAnonymization) => Cardidy.Identify(cardNumber, useAlgorithm: false, handleAnonymization: handleAnonymization);
}